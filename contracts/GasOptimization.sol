...
// they are the only functions in the contract because the evm adds 20 gas for r each new function or external variable ... 😡
...
//other ideas:
//using first bit as signuature for sigpos/neg